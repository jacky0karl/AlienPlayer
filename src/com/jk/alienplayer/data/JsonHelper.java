...
public class JsonHelper {
    ...
    public static List<NetworkSearchResult> parseArtists(String jsonStr) {
    ...
    public static List<NetworkSearchResult> parseAlbums(String jsonStr) {
    ...
    public static List<NetworkSearchResult> parseTracks(String jsonStr) {
